...
#python .\test_adv.py --model APPNP --alpha 0.2 --dataset Cora
#python .\test_adv.py --model APPNP --alpha 0.2 --dataset CiteSeer
#python .\test_adv.py --model APPNP --alpha 0.2 --dataset PubMed
